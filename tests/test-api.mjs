...
async function runTests() {
  ...
  try {
    ...
    try {
      ...
      console.log(`   ✅ Traffic: ${traffic.trafficUsedGB.toFixed(2)}/${traffic.purchasedTrafficGB.toFixed(2)} GB`);
      console.log(`   Available: ${traffic.availableTrafficGB.toFixed(2)} GB`);
      console.log(`   Price: $${traffic.pricePerGB}/GB`);
    } catch (e) {
